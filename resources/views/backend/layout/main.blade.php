...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard.index')}}">
                ...
                <div class="sidebar-brand-text mx-3">Admin WinniCode</div>
            </a>
    ...
    <script>
        ...
        CKEDITOR.replace('editor', {
            height: 300, // Tinggi editor dalam piksel
...
<script>
    function tampilkanPreview(input, idPreview) {
        ...
        if (file) {
            ...
            document.getElementById(idPreview).style.display = "none"; // Sembunyikan gambar
        }
    }
</script>
